...
export default function Bookmarks(): JSX.Element {
  ...
  return (
    <MainContainer>
      <SEO title='Bookmarks / Degen Diaries' />
      <Modal
      ...
      <section className='mt-0.5'>
        {bookmarksRefLoading || tweetLoading ? (
          ...
          <StatsEmpty
            title='Save Diaries for later'
            description='Don’t let the good ones fly away! Bookmark Diaries to easily find them again in the future.'
