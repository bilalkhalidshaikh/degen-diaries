...
function TwitterIcon({ className }: IconProps): JSX.Element {
  return (
    <svg className={cn('fill-current', className)} viewBox='0 0 24 24'>
      <path
        d='M512 1024C794.39 1024 1024 794.39 1024 512C1024 229.61 794.39 0 512 0C229.61 0 0 229.61 0 512C0 794.39 229.61 1024 512 1024Z'
        fill='#0F172A'
      />
      <path
        d='M512 950C764.097 950 950 764.097 950 512C950 259.903 764.097 74 512 74C259.903 74 74 259.903 74 512C74 764.097 259.903 950 512 950Z'
        fill='url(#paint0_linear_18_9)'
      />
      <path
        fill-rule='evenodd'
        clip-rule='evenodd'
        d='M512 950C764.097 950 950 764.097 950 512C950 259.903 764.097 74 512 74C259.903 74 74 259.903 74 512C74 764.097 259.903 950 512 950ZM512 1024C794.39 1024 1024 794.39 1024 512C1024 229.61 794.39 0 512 0C229.61 0 0 229.61 0 512C0 794.39 229.61 1024 512 1024Z'
        fill='#4F46E5'
      />
      <path
        fill-rule='evenodd'
        clip-rule='evenodd'
        d='M512 921.103C747.221 921.103 921.103 747.221 921.103 512C921.103 276.779 747.221 102.897 512 102.897C276.779 102.897 102.897 276.779 102.897 512C102.897 747.221 276.779 921.103 512 921.103ZM512 950C764.097 950 950 764.097 950 512C950 259.903 764.097 74 512 74C259.903 74 74 259.903 74 512C74 764.097 259.903 950 512 950Z'
        fill='white'
      />
      <defs>
        <linearGradient
          id='paint0_linear_18_9'
          x1='74'
          y1='512'
          x2='950'
          y2='512'
  ...
  return (
    <>
      <img
        ...
        width='100'
        height='100'
        src='https://img.icons8.com/stickers/100/metamask-logo.png'
        alt='metamask-logo'
      />
    </>
  );
