...
//             </div>
//             <Button
//               className='flex cursor-pointer p-6 justify-center gap-2 border border-light-line-reply bg-opacity-30 font-bold text-light-primary backdrop-blur-lg transition hover:bg-[#e6e6e6] focus-visible:bg-[#e6e6e6] active:bg-[#cccccc] dark:border-0 dark:bg-white dark:hover:brightness-90 dark:focus-visible:brightness-90 dark:active:brightness-75'
...
//             {/* // onClick={signInWithGoogle}
//             <Button
//               className='border bg-opacity-40 p-4 shadow-md backdrop-blur-md dark:bg-[#2a51be0e] border-light-line-reply font-bold text-accent-blue hover:bg-accent-blue/10 focus-visible:bg-accent-blue/10 focus-visible:!ring-accent-blue/80 active:bg-accent-blue/20 dark:border-light-secondary'
//             >
//               Sign in
//             </Button> */}
      ...
      <div className='flex w-full max-w-md flex-col items-center justify-center rounded-lg bg-white bg-opacity-30 p-8 backdrop-blur-lg'>
        ...
        <div className='flex flex-col gap-6 py-2'>
          ...
          <div className='mt-6 flex w-full flex-col gap-3'>
            ...
            <Button
              className='flex w-full items-center justify-center gap-2 border border-light-line-reply bg-opacity-30 font-bold text-light-primary backdrop-blur-lg transition hover:bg-[#e6e6e6] focus-visible:bg-[#e6e6e6] active:bg-[#cccccc] dark:border-0 dark:bg-white dark:hover:brightness-90 dark:focus-visible:brightness-90 dark:active:brightness-75'
              onClick={connectWithWallet}
            >
              <CustomIcon iconName='MetaMaskIcon' /> Register with Web3.0
            </Button>
            <Button
              className='flex w-full items-center justify-center gap-2 border border-light-line-reply px-16 py-4 font-bold
